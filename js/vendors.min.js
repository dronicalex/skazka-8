...
if (1) {
	let sel = document.querySelector('.sel-header__it');
	let select = document.querySelector('.sel-header__el');
	let table = document.querySelector('.sel-header__table');
	table.addEventListener('click', function (e) {
		e = e.target
		sel.innerHTML = ''
		i = document.importNode(e, true)
		console.log(i)
		sel.appendChild(i)
		table.classList.remove('_active')
	})
	select.addEventListener('click', function () {
		table.classList.toggle('_active')
		select.classList.toggle('_active')
	})

}
if (1) {
	let sel = document.querySelector('.sel-prost__it');
	let select = document.querySelector('.sel-prost__el');
	let table = document.querySelector('.sel-prost__table');
	table.addEventListener('click', function (e) {
		e = e.target
		sel.innerHTML = ''
		i = document.importNode(e, true)
